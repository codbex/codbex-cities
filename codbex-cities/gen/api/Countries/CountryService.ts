...
const validationModules = await Extensions.loadExtensionModules("codbex-cities-Countries-Country", ["validate"]);
...
class CountryService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-cities/gen/api/Countries/CountryService.ts/" + entity.Id);
