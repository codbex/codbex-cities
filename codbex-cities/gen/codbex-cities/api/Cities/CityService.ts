...
import { CityRepository, CityEntityOptions } from "../../dao/Cities/CityRepository";
import { user } from "sdk/security"
import { ForbiddenError } from "../utils/ForbiddenError";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-cities-Cities-City", ["validate"]);

@Controller
class CityService {

    private readonly repository = new CityRepository();

    @Get("/")
    public getAll(_: any, ctx: any) {
        try {
            this.checkPermissions("read");
            const options: CityEntityOptions = {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-cities/gen/codbex-cities/api/Cities/CityService.ts/" + entity.Id);
